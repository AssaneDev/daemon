                ...
                <div class="row">
                        ...
                        <div class="widget footer-widget wow fadeInUp" data-wow-delay=".6s">
                            <div class="gt-widget-about">
                                <div class="about-logo">
                                    <a href="index.html"><img src=" {{asset('frontend/assets/img/logo-daemon-fotter.png')}} "
                                            alt="extech"></a>
                                </div>
                                <p class="about-text"> Daemon Tech
                                    L'agence
                                    présent pour vos besoins numérique
                                </p>
                    ...
                    <div class="col-xl-2 col-md-6 col-12">
                        <div class="widget widget_nav_menu footer-widget wow fadeInUp" data-wow-delay="1s">
                            <h3 class="widget_title">Liens Rapidess</h3>
                            <div class="menu-all-pages-container">
                                <ul class="menu">
                                    <li><a href=""><i class="fa-solid fa-chevrons-right"></i>A propos</a>
                                    </li>
                                    <li><a href=""><i class="fa-solid fa-chevrons-right"></i>Nos
                                            Services</a>
                                    </li>
                                    ...
                                    <li><a href="https://zcal.co/daemontech/30min"><i
                                                class="fa-solid fa-chevrons-right"></i> Nous
                                            Contactez</a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="widget widget_nav_menu footer-widget wow fadeInUp" data-wow-delay="1.6s">
                            <h3 class="widget_title">Contact Nous</h3>
                            <div class="checklist style2">
                                <ul class="ps-0">
                                    <li class="text-white"><i class="fa-solid fa-envelope"></i></li>
                                    <li class="text-white">info@daemon.com</li>
                                </ul>
                                <ul class="ps-0">
                                    <li class="text-white"><i class="fa-solid fa-phone"></i></li>
                                    <li class="text-white">77 111 74 20 - 33 999 41 57 - 77 460 42 13</li>
                                </ul>
                                <div class="email-input-container">
                                    <input type="email" id="email" placeholder="Votre Address Email" required="">
        ...
        <div class="container">
            <div class="copyright-layout">
                <div class="layout-text wow fadeInUp" data-wow-delay=".3s">
                    <p class="copyright">
                        <i class="fal fa-copyright"></i>Copyright Daemon Tech 2024 <a href="index.html"></a>
                    </p>
                </div>
